...
_Generated from `results/blocks.jsonl` (7 live blocks). Do not hand-edit — run `node scripts/results.mjs --write-agents`._
...
**Current state (identities and rung, not measurements — for those read the ledger):** incumbent is `out/r3fixed/lam0.97/makruk-tiny-v1-4452f72612f1.bin`; d6 is rejected; the Gate B rung is **skill 5** (34.4%, needs ≥50%).
